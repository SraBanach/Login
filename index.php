...
<body>
    ...
    <h1>Login</h1>
        ...
        <a class="btn btn-primary" href="./cadastro.php?= $linha['id'] ?>" role="button">Cadastrar</a>
        <br>
        <a class="btn btn-primary" href="./usuario-esquecer.php?= $linha['id'] ?>" role="button">Esqueci a senha</a>
